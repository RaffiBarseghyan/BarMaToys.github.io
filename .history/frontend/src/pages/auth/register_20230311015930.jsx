...
export default function Register() {
  ...
  const [axiosErr, setphone] = useState("");
  ...
  const register = () => {
    ...
    if (name == "") {
      ...
      axios
        .post(`http://barmatoys.loc/api/create/user`, formData).catch(function (error) { console.log(error.toJSON().message.substring(32,40));})
        .then((res) => {
