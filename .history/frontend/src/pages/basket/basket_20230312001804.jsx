            ...
            return data.map((dataitem) => {
              return (
                <tr key={item.id}>
                  ...
                  <th scope="col"></th>
                  {dataitem.id == item.toyId ? <th scope="row">{dataitem.name}</th>:""}
                  {dataitem.id == item.toyId ? <th scope="row">{dataitem.price}</th>:""}
                  {dataitem.id == item.toyId ? <th scope="row">{item.count}</th>:""}
                  {dataitem.id == item.toyId ? <th scope="row">{item.count * dataitem.price}</th>:""}
