...
function Basket() {
  ...
  // const Greeting = memo((prevProps, nextProps) => {
  //   console.info(prevProps);
  //   console.info(nextProps);
  //   if (prevProps.step.show === nextProps.step.show) {
  //     return true;
  //   }
  //   return false;
  // });

  const Item = ({ step }) => <div>{step.count}</div>;
  const Greeting = React.memo(Item, (prevProps, nextProps) => {
              ...
              if (item.toyId == dataitem.id) {
                return (
                  <tr key={item.id}>
                    ...
                    <Greeting count={count} id={item.id} key={item.id} step={item} />
