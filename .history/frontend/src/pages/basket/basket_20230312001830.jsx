            ...
            return data.map((dataitem) => {
              return (
                <tr key={item.id}>
                  ...
                  <th scope="col"></th>
                  {dataitem.id == item.toyId ? <t scope="row">{dataitem.name}</t>:""}
                  {dataitem.id == item.toyId ? <t scope="row">{dataitem.price}</t>:""}
                  {dataitem.id == item.toyId ? <t scope="row">{item.count}</t>:""}
                  {dataitem.id == item.toyId ? <t scope="row">{item.count * dataitem.price}</t>:""}
