...
export default function Checkout(id) {
  ...
  const completedSteps = () => {
    if (Object.keys(completed).length === totalSteps()) {
      setTimeout(() => {
  ...
  const handleComplete = () => {
    ...
    } else if (checkboxVal == false && activeStep === 2) {
        ...
        <div>
          {allStepsCompleted() ? (
            ...
            <React.Fragment>
                ...
                {activeStep + 1 == 2 ? (
                  ...
                  >
                    <header closeButton className={style.button1}>
                      <div className="m-4 h2 text-center">{t("Payment")}</div>
                    </header>
                    ...
                    <div className={`${style.moreBody} container`}>
                      ...
                      >
                        <p className="ps-5 pe-5">
                          {t("PaymentText")} <br />
                          1. <b>{t("PaymentText1")}</b>
                          {t("PaymentText2")} <br />
                          2. <b>{t("PaymentText3")}</b>
                          {t("PaymentText4")} <br />
                          3. <b>{t("PaymentText5")}</b>
                          {t("PaymentText6")} <br />
                          4. <b>{t("PaymentText7")}</b>
                          {t("PaymentText8")}
                          <samp className={style.underline}>
                            {t("PaymentText9")} <br />
                          </samp>
                          5. <b>{t("PaymentText10")}</b>
                          {t("PaymentText11")}
                          <samp className={style.underline}>
                            {t("PaymentText12")} <br />
                          </samp>
              ...
              <Box className='d-flex justify-content-center' sx={{ display: "flex" , flexDirection: "row", pt: 2 }}>
                

                <Button className={style.continueBtn} onClick={handleComplete}>
