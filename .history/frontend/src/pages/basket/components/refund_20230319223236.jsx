      ...
      >
        ...
        <Modal.Body className={`${style.moreBody} container`}>
          <Modal.Title className={style.itemName}>
            ...
            բացառությունների/։ 2․ Եթե չի համապատասխանում նկարագրություններին կամ
            նկարի միջի պատկերված ապրանքին։ 3․Եթե հաճախորդի համար հատուկ պատվերով
            ներմուծվաճ կամ պատրաստված ապրանք չէ։ 4․Վերադաձի ենքակա չեն
            օգտագործված խաղալիքները:
          </Modal.Title>
        </Modal.Body>
