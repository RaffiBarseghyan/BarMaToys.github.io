        ...
        <Modal.Body className={`${style.moreBody} container`}>
          ...
          >
            <p className="ps-5 pe-5">
              ...
              2․ <b>Փոխանցում հաշվեհամարին՝</b> 2052 0614 1975 7001 <br />
              (ստացող՝ Milena Ghazaryan) <br />
              3․ <b>Փոխանցում քարտին՝</b> Inecobank 4578 8900 0059 0669 <br />
              4․ <b>Իդրամ էլ․ դրամապանակով՝</b> նշեք պարզապես <br />
              հեռախոսահամարը՝ <samp className={style.underline}>+374 55 799599</samp>  <br />
              5. <b>Արագ դրամական փոխանցումն՝</b> Ուղարկելով գումարը, <br />
              ստացողը դաշտում նշեք մեր աշխատակցի անուն- <br />
              Ազգանունը՝ <samp className={style.underline}>Սվետլանա Ղազարյան /Svetlana Ghazaryan</samp> ։ <br />
