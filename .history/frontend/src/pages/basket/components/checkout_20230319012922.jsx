        ...
        <Modal.Body className={`${style.moreBody} container`}>
          <Modal.Title className={`${style.itemName}`}>
            <p className="ps-5 pe-5">
              ...
              799599 <br />
              5.Արագ դրամական փոխանցումն՝ Ուղարկելով գումարը, ստացողը դաշտում
              նշեք մեր աշխատակցի անուն- Ազգանունը՝ Սվետլանա Ղազարյան /Svetlana
              Ghazaryan։ Ուշադրություն, առցանց վճարման դեպքում պարտադիր նամակի
              տեսքով ուղարկեք մեզ փոխանցումը հաստատող փաստաթղթի նկարը, որպեզի
