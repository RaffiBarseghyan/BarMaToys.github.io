        ...
        <Modal.Body className={`${style.moreBody} container`}>
          <Modal.Title className={`${style.itemName}`}>
            <p className="ps-5 pe-5">
              ...
              1․ Կանխիկ՝ վճարելով անմիջապե մեր առաքիչին։ <br /> 2․․Փոխանցում
              հաշվեհամարին՝ 2052 0614 1975 7001 (ստացող՝ Milena Ghazaryan)
              3․Փոխանցում քարտին՝ Inecobank 4578 8900 0059 0669 4․Իդրամ էլ․
              դրամապանակով՝ նշեք պարզապես հեռախոսահամարը՝ +374 55 799599 5.Արագ
              դրամական փոխանցումն՝ Ուղարկելով գումարը, ստացողը դաշտում նշեք մեր
              աշխատակցի անուն- Ազգանունը՝ Սվետլանա Ղազարյան /Svetlana Ghazaryan։
              Ուշադրություն, առցանց վճարման դեպքում պարտադիր նամակի տեսքով
              ուղարկեք մեզ փոխանցումը հաստատող փաստաթղթի նկարը, որպեզի
              կարողանանք ավելի օպերատիվ կազմակերպել առաքումը։
            </p>
          </Modal.Title>
        </Modal.Body>
