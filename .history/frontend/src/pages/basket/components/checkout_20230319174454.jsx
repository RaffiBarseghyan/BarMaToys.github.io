    ...
    <div>
      <MuiThemeProvider>
        <div className="background">
          <div>
            <Card>
              <Tabs value={this.state.currentTab} onChange={handleChange}>
                <Tab label="General" value="a">
                  <div>
                    //Sets the currentTab value to "b" which corresponds to the
                    description tab
                    <button onClick={() => this.handleChange("b")}>
                      Normal button
                    </button>
                  </div>
                </Tab>
                <Tab label="Descriptions" value="b"></Tab>
                <Tab label="Content" value="c"></Tab>
                <Tab label="Sidebar" value="d"></Tab>
              </Tabs>
            </Card>
          </div>
        </div>
