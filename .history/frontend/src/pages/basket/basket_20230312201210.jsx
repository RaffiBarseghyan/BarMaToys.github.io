          ...
          {newArr.map((item) => {
            ...
            return (
              <tr key={item.toyId}>
                ...
                {item.id == item.toyId ? <td scope="row">{item.name}</td> : ""}
                {item.id == item.toyId ? <td scope="row">{item.price}</td> : ""}
                {item.id == item.toyId ? <td scope="row">{item.count}</td> : ""}
                {item.id == item.toyId ? (
