            ...
            return data.map((dataitem) => {
              return (
                <tr key={item.id}>
                  ...
                  <th scope="col"></th>
                  {dataitem.id == item.toyId ? <td scope="row">{dataitem.name}</td>:}
                  {dataitem.id == item.toyId ? <td scope="row">{dataitem.price}</td>:""}
                  {dataitem.id == item.toyId ? <td scope="row">{item.count}</td>:""}
                  {dataitem.id == item.toyId ? <td scope="row">{item.count * dataitem.price}</td>:""}
