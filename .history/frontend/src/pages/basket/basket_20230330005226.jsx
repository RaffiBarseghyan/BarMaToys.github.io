...
function Basket() {
  ...
  const [toyStar, setToyStar] = useState([]);
  ...
  useEffect(() => {
    ...
    axios.post(`http://barmatoys.loc/api/get/toystar`).then((res) => {
      const persons = res.data;
      setToyStar(persons.toyStar);
    ...
    <>
      ...
      <div className="container-fluid">
        <div className={style.alsoLikeBg}>
          ...
          <SliderGoal data={toyStar} file={file} text={t("Title1")} />
        </div>
      </div>
    </>
  );
