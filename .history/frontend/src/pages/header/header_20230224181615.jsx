            ...
            >
              ...
              <div className="d-flex">
                ...
                <select
                  ...
                  onChange={onChange}
                >
                  <option style="padding-left: 25px; background: no-repeat url(yellow.png) 4px 1px" style={{backgroundImage: "url('../../assets/images/Flag_of_Armenia.png')", width:"100px", height:"100px"}} selected={"am" == i18n.language} value="am">
                    <img src={Flag_of_Armenia} alt="" />
                  </option>
