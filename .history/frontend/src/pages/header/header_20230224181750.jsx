            ...
            >
              ...
              <div className="d-flex">
                ...
                <select
                  ...
                  onChange={onChange}
                >
                  <option  style={{paddingLeft:"25px", background: "no-repeat url('../../assets/images/Flag_of_Armenia.png') 4px 1px", width:"100px", height:"100px"}} selected={"am" == i18n.language} value="am">
