          ...
          >
            ...
            >
              ...
              <div className="d-flex">
                ...
                <select
                  className={`form-select form-select-sm ms-5 ${style.language}`}
                ...
                >
                  ...
                  <option selected={"am" == i18n.language} defaultValue="am">
                    Arm
                  </option>
                  <option selected={"en" == i18n.language} defaultValue="en">
                    Eng
                  </option>
                  <option selected={"ru" == i18n.language} defaultValue="ru">
                    Rus
                  </option>
                </select>
              </div>
