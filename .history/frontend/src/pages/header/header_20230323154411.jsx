...
import initialDetails from "./pages/header/search/data/initialDatails";
            ...
            >
              ...
              <div className="d-flex">
                ...
                <select
                  ...
                  onChange={onChange}
                >
                  <option style={{color:"blue"}} selected={"am" == i18n.language} value="am">
                    Arm
                  </option>
                  <option style={{color:"blue"}} selected={"en" == i18n.language} value="en">
                    Eng
                  </option>
                  <option style={{color:"blue"}} selected={"ru" == i18n.language} value="ru">
                    Rus
                  </option>
                </select>
              </div>
