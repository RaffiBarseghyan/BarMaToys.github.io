...
function Card({ person }) {
  ...
  return (
    ...
    >
      <div
        className="dib br3 pa1 ma2 grow bw2 shadow-5 d-flex justify-content-between"
        style={{ width: "300px", height: "100px", bgcolor:"#407ec9"}}
      >
        ...
        <div>{person.price}{t("taradram")}</div>
      </div>
    </Link>
  );
}
