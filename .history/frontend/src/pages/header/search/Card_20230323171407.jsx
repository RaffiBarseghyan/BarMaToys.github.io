...
function Card({ person }) {
  ...
  return (
    ...
    >
      <div
        className="dib br3 pa1 ma2 grow shadow-5 d-flex justify-content-between"
      ...
      >
        <div className="d-flex align-items-center">
          ...
          <div
            className={`d-flex flex-column align-items-start justify-content-center ${style.substr}`}
          >
            <h2>{person.name}</h2>
