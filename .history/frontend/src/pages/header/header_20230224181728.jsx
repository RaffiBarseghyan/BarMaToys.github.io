            ...
            >
              ...
              <div className="d-flex">
                ...
                <select
                  ...
                  onChange={onChange}
                >
                  <option  style={{padding:'le' background: "no-repeat url('../../assets/images/Flag_of_Armenia.png') 4px 1px", width:"100px", height:"100px"}} selected={"am" == i18n.language} value="am">
