...
export default function Clicks(id) {
  ...
  let x = 0;
  return (
    <div id="asdasdasd" className="d-flex justify-content-center" style={{width:"100%"}}>
      <button onClick={handleShow} className={`${style.basketButtonBasket} text-center d-flex justify-content-center`}>
        {t("AddtoBasket")}
      </button>
              ...
              <Modal.Title className={`${style.itemName} d-flex`}>
                ...
                >
                  <div className="d-flex flex-column align-items-start ">
                    <p className={style.description}>{id.description}</p>
