  ...
  const addBasket = () => {
    ...
    axios.post(`http://barmatoys.loc/api/get/basket`, fd).then((res) => {
      ...
      persons.data.map((item) => {
        console.log(item.toyId);

        console.log(id.id);
        console.log(item.toyId == id.id);
        console.log(item.userEmail);
        console.log(localStorage.getItem("loginEmail"));
        console.log(item.userEmail == localStorage.getItem("loginEmail"));
        ...
        if (
          ...
          axios.post(`http://barmatoys.loc/api/add/basket/up`, formData);
          Swal.fire({
            title: "Success",
