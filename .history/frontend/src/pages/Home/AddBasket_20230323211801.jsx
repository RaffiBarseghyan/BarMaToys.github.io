          ...
          >
            ...
            <Modal.Body className={`${style.moreBody} container`}>
              <Modal.Title className={`${style.itemName} d-flex `}>
                ...
                <div
                  className={`col-sm-6 d-flex flex-column justify-content-between ${style.rightPart}`}
                >
                  <div className={`d-flex flex-column align-items-start ${style.descriptionPrice}`}>
