            ...
            <Modal.Body className={`${style.moreBody} container`}>
              <Modal.Title className={`${style.itemName} d-flex`}>
                ...
                <div className="col-sm-6 d-flex">
                  <div className={style.cradlesBox}>
                    <div className={style.minus}><FaMinus /></div>
                    <input type="number" mobile  className={style.cradlesInp} />
                    <div className={style.minus}><FaPlus /></div>
                  </div>
                  <div><Button className={style.saveBasket} variant="primary">
                    {t("Addtobasket")}
                  </Button></div>
