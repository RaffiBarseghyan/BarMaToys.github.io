            ...
            return (
              ...
              >
                ...
                <button className={style.boxButton}>
                  <AddBasket id={item.id} name={item.name} color={item.color} item={item.item} goal1={item.goal1} goal1={item.goal1} goal1={item.goal1} goal1={item.goal1} goal1={item.goal1}/>
                </button>
              </SwiperSlide>
            );
          })}
