          ...
          >
            ...
            <form className={style.rating}>
              <div className={style.rating__stars}>
                <input
                  id="rating-1"
                  className={style.rating__input, style.rating__input-1}
                  type="radio"
                  name="rating"
                  value="1"
                />
                <input
                  id="rating-2"
                  className={style.rating__input, style.rating__input-2}
                  type="radio"
                  name="rating"
                  value="2"
                />
                <input
                  id="rating-3"
                  className={style.rating__input, style.rating__input-3}
                  type="radio"
                  name="rating"
                  value="3"
                />
                <input
                  id="rating-4"
                  className={style.rating__input, style.rating__input-4}
                  type="radio"
                  name="rating"
                  value="4"
                />
                <input
                  id="rating-5"
                  className={style.rating__input, style.rating__input-5}
                  type="radio"
                  name="rating"
                  value="5"
                />
                <label className={style.rating__label} for="rating-1">
                  ...
                  >
                    <g transform="translate(16,16)">
                      <circle
                        className={style.rating__star-ring}
                        fill="none"
                        stroke="#000"
                        stroke-width="16"
                        r="8"
                    ...
                    >
                      ...
                      >
                        <polyline
                          className={style.rating__star-line}
                          transform="rotate(0)"
                          points="0 4,0 16"
                        />
                        <polyline
                ...
                <p className={style.rating__display} data-rating="1" hidden>
                  Terrible
                </p>
                <p className={style.rating__display} data-rating="2" hidden>
                  Bad
                </p>
                <p className={style.rating__display} data-rating="3" hidden>
                  OK
                </p>
                <p className={style.rating__display} data-rating="4" hidden>
                  Good
                </p>
                <p className={style.rating__display} data-rating="5" hidden>
                  Excellent
                </p>
              </div>
            </form>
