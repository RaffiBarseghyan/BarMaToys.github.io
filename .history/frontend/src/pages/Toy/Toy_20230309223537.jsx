      ...
      <div className={`d-flex justify-content-center m-5`}>
        <div className="container-fluid mt-5">
          ...
          >
            ...
            <div className={`d-flex ${mid ? 'justify-content-between' : 'justify-content-center'}  ${style.section3Box}`}>
              {mid == 4 ? (
                <div className="d-flex">
                  ...
                  <p className={style.ratingp}>4 out of 5</p>
                </div>
              ) : (
                ""
              )}
              {mid == 4 ? (
                <div className="d-flex">
                  ...
                  <p className={style.ratingp}>5 out of 5</p>
                </div>
              ) : (
                ""
              )}
