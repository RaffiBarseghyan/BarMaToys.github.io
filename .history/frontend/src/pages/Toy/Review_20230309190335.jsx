...
export default function Clicks() {
  ...
  const submit = () => {
    if (stars == "") {
      ...
      formData.append("productId", localStorage.getItem("loginEmail"));
              ...
              >
                ...
                <div className={`d-flex align-items-center  ${style.ratings}`}>
                  <h3 className={`me-4 ${style.h3} d-flex align-items-center`}>
                    Rating <p className={style.astxanish}>*</p>
                  </h3>
                ...
                <label className={`align-items-center  ${style.ratings2}`}>
                  <h3 className={`me-4 ${style.h3} d-flex align-items-center`}>
                    Review <p className={style.astxanish}>*</p>
                  </h3>
                  <textarea
                    cols="30"
                    rows="10"
