...
import "./star";
import pencir from "../../assets/images/pencil.png"
      ...
      <div className={`d-flex justify-content-center m-5`}>
        <div className="container-fluid mt-5">
          ...
          >
            ...
            <div className={style.stars}>
              <form className={style.rating}>
                <div className={style.rating__stars}>
                  ...
                  />
                  <label className={style.rating__label} htmlFor="rating-1">
                    <svg
                  ...
                  <label className={style.rating__label} htmlFor="rating-2">
                    <svg
                      className={style.rating__star}
                      width="32"
                      height="32"
                  ...
                  <label className={style.rating__label} htmlFor="rating-5">
                    <svg
                      className={style.rating__star}
                      width="32"
                      height="32"
            ...
            <button className={style.writeReview}>Write a review</button>
          </div>
        </div>
      </div>
    </>
