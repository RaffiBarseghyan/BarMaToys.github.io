        ...
        >
          ...
          <div className="d-flex justify-content-center">
            ...
            <div className="d-flex flex-column align-items-start">
              ...
              {data.goal2 == "true" ? <h3>{t("Title1")}</h3> : ""}
              {data.goal3 == "true" ? <h3>{t("Title1")}</h3> : ""}
              {data.goal4 == "true" ? <h3>{t("Title1")}</h3> : ""}
              {data.goal5 == "true" ? <h3>{t("Title1")}</h3> : ""}
              {data.goal6 == "true" ? <h3>{t("Title1")}</h3> : ""}
              {data.goal7 == "true" ? <h3>{t("Title1")}</h3> : ""}
            </div>
          </div>
          <div className="d-flex justify-content-center">
                  ...
                  return (
                    <>
                      <div className={style.section4BigBox} key={item.id}>
                        ...
                        {user.map((items) => {
                          return (
                            <div className={style.section4BigBoxName}>
