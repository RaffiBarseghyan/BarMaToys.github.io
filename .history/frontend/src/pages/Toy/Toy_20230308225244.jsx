            ...
            <div className={style.stars}>
              <form className={style.rating}>
                <div className={style.rating__stars}>
                  ...
                  <input
                    id="rating-2"
                    className={style.rating__input_2}{`${style.rating__input_1} ${style.rating__input}`}
                    type="radio"
                    name="rating"
                    value="2"
                  />
                  <input
                    id="rating-3"
                    className={style.rating__input_3}{`${style.rating__input_1} ${style.rating__input}`}
                    type="radio"
                    name="rating"
                    value="3"
                  />
                  <input
                    id="rating-4"
                    className={style.rating__input_4}{`${style.rating__input_1} ${style.rating__input}`}
                    type="radio"
                    name="rating"
                    value="4"
                  />
                  <input
                    id="rating-5"
                    className={style.rating__input_5}{`${style.rating__input_1} ${style.rating__input}`}
                    type="radio"
                    name="rating"
                    value="5"
                  />
