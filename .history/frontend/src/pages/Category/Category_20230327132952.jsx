        ...
        >
          ...
          >
            <Accordion.Item eventKey="0">
              <Accordion.Header className={style.}>Price</Accordion.Header>
              <Accordion.Body>
            ...
            <Accordion.Item eventKey="1">
              <Accordion.Header className={style.}>Color</Accordion.Header>
              <Accordion.Body>
            ...
            <Accordion.Item eventKey="2">
              <Accordion.Header className={style.}>Material</Accordion.Header>
              <Accordion.Body></Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="3">
              <Accordion.Header className={style.}>Goal</Accordion.Header>
              <Accordion.Body></Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="4">
              <Accordion.Header className={style.}>Age</Accordion.Header>
              <Accordion.Body></Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="5">
              <Accordion.Header className={style.}>Rating</Accordion.Header>
              <Accordion.Body></Accordion.Body>
            </Accordion.Item>
          </Accordion>
