...
function Category() {
  ...
  const [materialTree, setGoal7] = useState("");
  const [materialPaper, setGoal7] = useState("");
  const [materialCloth, setGoal7] = useState("");
  const [materialPlastic, setGoal7] = useState("");
  const [materialTree, setGoal7] = useState("");
  const [materialPaper, setGoal7] = useState("");
  const [materialCloth, setGoal7] = useState("");
  const [materialPlastic, setGoal7] = useState("");
