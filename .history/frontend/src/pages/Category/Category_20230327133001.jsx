        ...
        >
          ...
          >
            <Accordion.Item eventKey="0">
              <Accordion.Header className={style.accordion}>Price</Accordion.Header>
              <Accordion.Body>
            ...
            <Accordion.Item eventKey="1">
              <Accordion.Header className={style.accordion}>Color</Accordion.Header>
              <Accordion.Body>
            ...
            <Accordion.Item eventKey="2">
              <Accordion.Header className={style.accordion}>Material</Accordion.Header>
              <Accordion.Body></Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="3">
              <Accordion.Header className={style.accordion}>Goal</Accordion.Header>
              <Accordion.Body></Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="4">
              <Accordion.Header className={style.accordion}>Age</Accordion.Header>
              <Accordion.Body></Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="5">
              <Accordion.Header className={style.accordion}>Rating</Accordion.Header>
              <Accordion.Body></Accordion.Body>
            </Accordion.Item>
          </Accordion>
