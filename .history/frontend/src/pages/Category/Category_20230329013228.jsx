...
function Category() {
  ...
  const [Goal2, setGoal2] = useState(true);
  const [Goal3, setGoal3] = useState(true);
  const [Goal4, setGoal4] = useState(true);
  const [Goal5, setGoal5] = useState(true);
  const [Goal6, setGoal6] = useState(true);
  const [Goal7, setGoal7] = useState(true);
  ...
  const filteredPersons = initialDetails().filter((person) => {
    console.log(person.goal1);
    return (
      (person.name.toLowerCase().includes(searchField.toLowerCase()) ||
        person.description.toLowerCase().includes(searchField.toLowerCase())) &&
      (person.goal7.includes(Goal1) ||
        person.goal7.includes(Goal2) ||
        person.goal7.includes(Goal3) ||
        person.goal7.includes(Goal4) ||
        person.goal7.includes(Goal5) ||
        person.goal7.includes(Goal6) ||
        person.goal7.includes(Goal7)) &&
      (person.goal6.includes(Goal1) ||
        person.goal6.includes(Goal2) ||
        person.goal6.includes(Goal3) ||
        person.goal6.includes(Goal4) ||
        person.goal6.includes(Goal5) ||
        person.goal6.includes(Goal6) ||
        person.goal6.includes(Goal7))
    );
  });
