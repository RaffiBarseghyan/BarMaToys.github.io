...
function CategoryList({ filteredPersons }) {
  ...
  return (
    ...
    >
      <div class="accordion col-sm-2" id="accordionExample">
      ...
      <div className="col-sm-10 d-flex flex-wrap align-items-center justify-content-around container">{filtered} </div>
    </div>
  );
}
