        ...
        >
          ...
          >
            <Accordion.Item eventKey="0">
              <Accordion.Header className={style.accordionHeader}>Price</Accordion.Header>
              <Accordion.Body>
            ...
            <Accordion.Item eventKey="1">
              <Accordion.Header className={style.accordionHeader}>Color</Accordion.Header>
              <Accordion.Body>
            ...
            <Accordion.Item eventKey="2">
              <Accordion.Header className={style.accordionHeader}>Material</Accordion.Header>
              <Accordion.Body></Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="3">
              <Accordion.Header className={style.accordionHeader}>Goal</Accordion.Header>
              <Accordion.Body></Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="4">
              <Accordion.Header className={style.accordionHeader}>Age</Accordion.Header>
              <Accordion.Body></Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="5">
              <Accordion.Header className={style.accordionHeader}>Rating</Accordion.Header>
              <Accordion.Body></Accordion.Body>
            </Accordion.Item>
          </Accordion>
