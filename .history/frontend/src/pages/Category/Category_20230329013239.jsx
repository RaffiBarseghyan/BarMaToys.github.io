...
function Category() {
  ...
  const filteredPersons = initialDetails().filter((person) => {
    ...
    return (
      ...
      (person.goal1.includes(Goal1) ||
        person.goal1.includes(Goal2) ||
        person.goal1.includes(Goal3) ||
        person.goal1.includes(Goal4) ||
        person.goal1.includes(Goal5) ||
        person.goal1.includes(Goal6) ||
        person.goal1.includes(Goal7))
    );
  });
