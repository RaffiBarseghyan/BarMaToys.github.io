      ...
      <div className={`d-flex ${style.itemName} `}>
        ...
        <div className={`col-sm-6 ${style.rightBox}`}>
          ...
          <div className="d-flex justify-content-center">
            ...
            <div>
              {data.goal1 ? <h3>Ուշադրության զարգացնող</h3> : ""}
              {data.goal2 ? <h3>Հիշողության զարգացնող</h3> : ""}
              {data.goal3 ? <h3>Տրամաբանության զարգացնող</h3> : ""}
              {data.goal4 ? <h3>Մտածողության զարգացնող</h3> : ""}
              {data.goal5 ? <h3>Մանր մոտորիկա զարգացնող</h3> : ""}
              {data.goal6 ? <h3>Մեծ մոտորիկա զարգացնող</h3> : ""}false
              {data.goal7 ? <h3>Ընկալման զարգացնող</h3> : ""}
            </div>
          </div>
        </div>
      </div>
