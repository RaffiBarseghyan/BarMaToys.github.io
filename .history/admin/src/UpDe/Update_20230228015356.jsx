...
export default function Update() {
  ...
  const [gin, setgin] = useState(from.gin);
        ...
        <div className={`${style.colors} mt-5`}>
          ...
          <div className="ms-5">
            ...
            >
              ...
              <option name="color1" style={{ color: "#000000" }} value={"color1"}>
                Սև
              </option>
              <option name="color2" style={{ color: "#000000" }} value={"color2"}>
                Սպիտակ
              </option>
              <option
                name="color3"
              ...
              <option name="color4" style={{ color: "#e00" }} value={"color4"}>
                Կարմիր
              </option>
              <option
                name="color5"
              ...
              <option name="color6" style={{ color: "#00c" }} value={"color6"}>
                Կապույտ
              </option>
              <option name="color7" style={{ color: "#0c0" }} value={"color7"}>
                Կանաչ
              </option>
              <option name="color8" style={{ color: "#ccc" }} value={"color8"}>
                Մոխրագույն
              </option>
              <option
                name="color9"
